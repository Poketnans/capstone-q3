...
from app.controllers.tattoos_controllers import get_specific, get_all, update, create, get_image, finish_session
...
bp_tattoos.patch("/finish/<id_tattoo>")(finish_session)
