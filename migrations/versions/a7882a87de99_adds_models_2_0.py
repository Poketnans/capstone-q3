...
def upgrade():
    ...
    op.create_table('tattoo_images',
                    ...
                    sa.Column('id_tattoo', postgresql.UUID(
                        as_uuid=True), nullable=True),
                    sa.ForeignKeyConstraint(['id_tattoo'], ['tattoos.id'], ),
                    sa.PrimaryKeyConstraint('id')
                    )
    op.add_column('clients', sa.Column(
        'image_name', sa.String(), nullable=True))
    op.add_column('clients', sa.Column(
        'image_bin', sa.LargeBinary(), nullable=True))
    op.add_column('clients', sa.Column(
        'image_mimetype', sa.String(), nullable=True))
    op.add_column('materials', sa.Column(
        'id_storage', postgresql.UUID(as_uuid=True), nullable=True))
    op.add_column('materials', sa.Column(
        'id_tattoo', postgresql.UUID(as_uuid=True), nullable=True))
    op.drop_constraint('materials_id_product_fkey',
                       'materials', type_='foreignkey')
    op.drop_constraint('materials_id_order_fkey',
                       'materials', type_='foreignkey')
    ...
    op.add_column('tattooists', sa.Column(
        'image_name', sa.String(), nullable=True))
    op.add_column('tattooists', sa.Column(
        'image_bin', sa.LargeBinary(), nullable=True))
    op.add_column('tattooists', sa.Column(
        'image_mimetype', sa.String(), nullable=True))
    op.add_column('tattoos', sa.Column(
        'id_session', postgresql.UUID(as_uuid=True), nullable=True))
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('tattoos', sa.Column(
        'id_event', postgresql.UUID(), autoincrement=False, nullable=True))
    op.add_column('tattoos', sa.Column('duration', sa.INTEGER(),
                  autoincrement=False, nullable=False))
    op.drop_constraint(None, 'tattoos', type_='foreignkey')
    op.create_foreign_key('tattoos_id_event_fkey', 'tattoos',
                          'events', ['id_event'], ['id'])
    op.alter_column('tattoos', 'colors',
                    existing_type=sa.BOOLEAN(),
                    nullable=True)
    ...
    op.add_column('materials', sa.Column(
        'id_product', postgresql.UUID(), autoincrement=False, nullable=True))
    op.add_column('materials', sa.Column(
        'id_order', postgresql.UUID(), autoincrement=False, nullable=True))
    op.drop_constraint(None, 'materials', type_='foreignkey')
    op.drop_constraint(None, 'materials', type_='foreignkey')
    op.create_foreign_key('materials_id_order_fkey',
                          'materials', 'orders', ['id_order'], ['id'])
    op.create_foreign_key('materials_id_product_fkey',
                          'materials', 'products', ['id_product'], ['id'])
    ...
    op.create_table('events',
                    ...
                    sa.Column('start', postgresql.TIMESTAMP(),
                              autoincrement=False, nullable=True),
                    sa.Column('end', postgresql.TIMESTAMP(),
                              autoincrement=False, nullable=True),
    ...
    op.create_table('orders',
                    ...
                    sa.ForeignKeyConstraint(
                        ['id_tattoo'], ['tattoos.id'], name='orders_id_tattoo_fkey'),
